...
->name('dashboard.wallet.topup.store');
    ...
    Route::middleware('can:apply job')->group(function(){
        ...
        Route::get('/dashboard/proposals_details/{projectApplicant}', [DashboardController::class, 'proposals_details'])
        ->name('dashboard.proposal_details');
        
    });
    Route::prefix('admin')->name('admin.')->group(function () {
        Route::middleware('can:manage wallets')->group(function (){
            Route::get('/wallet/topups', [WalletTransactionController::class, 'wallets_topups'])
            ->name('topups');
        ...
        Route::middleware('can:manage projects')->group(function (){
            ...
            ->name('project.tools');
            Route::get('/project/{project}/tools/store',[ProjectController::class, 'tools_store'])
